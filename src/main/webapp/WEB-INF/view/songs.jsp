        ...
        <tr>
            <th>
                      <span>
                        Title
                          <span class="carrets">
                              <a href="${pageContext.request.contextPath}/songs?inst=${pageContext.request.getParameter("inst")}&sort=TitleDESC"><i
                                      class="fa fa-sharp fa-solid fa-caret-up"></i></a>
                              <a href="${pageContext.request.contextPath}/songs?inst=${pageContext.request.getParameter("inst")}&sort=TitleASC"><i
                                      class="fa fa-sharp fa-solid fa-caret-down"></i></a>
                          </span>
                      </span>
            </th>
            <th>
                      <span>
                        Artist
                          <span class="carrets">
                              <a href="${pageContext.request.contextPath}/songs?inst=${pageContext.request.getParameter("inst")}&sort=ArtistDESC"><i
                                      class="fa fa-sharp fa-solid fa-caret-up"></i></a>
                              <a href="${pageContext.request.contextPath}/songs?inst=${pageContext.request.getParameter("inst")}&sort=ArtistASC"><i
                                      class="fa fa-sharp fa-solid fa-caret-down"></i></a>
                          </span>
                      </span>
            </th>
            <th>
                      <span>
                          Instrument
                          <div class="dropdown">
                              <button onclick="filterToggle()" class="dropbtn"><span class="dropbtn"><i
                                      class="fa fa-solid fa-filter dropbtn"></i></span></button>
            ...
            <th>
                      <span>
                        Length
                          <span class="carrets">
                              <a href="${pageContext.request.contextPath}/songs?inst=${pageContext.request.getParameter("inst")}&sort=LengthDESC"><i
                                      class="fa fa-sharp fa-solid fa-caret-up"></i></a>
                              <a href="${pageContext.request.contextPath}/songs?inst=${pageContext.request.getParameter("inst")}&sort=LengthASC"><i
                                      class="fa fa-sharp fa-solid fa-caret-down"></i></a>
                          </span>
                      </span>
            </th>
            <th>
                      <span>
                        Played
                          <span class="carrets">
                              <a href="${pageContext.request.contextPath}/songs?inst=${pageContext.request.getParameter("inst")}&sort=TimesPlayedDESC"><i
                                      class="fa fa-sharp fa-solid fa-caret-up"></i></a>
                              <a href="${pageContext.request.contextPath}/songs?inst=${pageContext.request.getParameter("inst")}&sort=TimesPlayedASC"><i
                                      class="fa fa-sharp fa-solid fa-caret-down"></i></a>
                          </span>
                      </span>
            </th>
            <th>
                      <span>
                        Last Played
                          <span class="carrets">
                              <a href="${pageContext.request.contextPath}/songs?inst=${pageContext.request.getParameter("inst")}&sort=LastPlayedDESC"><i
                                      class="fa fa-sharp fa-solid fa-caret-up"></i></a>
                              <a href="${pageContext.request.contextPath}/songs?inst=${pageContext.request.getParameter("inst")}&sort=LastPlayedASC"><i
                                      class="fa fa-sharp fa-solid fa-caret-down"></i></a>
                          </span>
                      </span>
            </th>
