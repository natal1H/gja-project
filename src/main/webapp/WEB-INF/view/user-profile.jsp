...
<body>
    ...
    SORT BY:
    <form id="sortForm" action="${pageContext.request.contextPath}/profile?id=${pageContext.request.getParameter("id")}&inst=${pageContext.request.getParameter("inst")}" method="get">
    ...
    <hr>
    <a href="${pageContext.request.contextPath}/profile?id=${user.id}&inst=ALL&sort=${pageContext.request.getParameter("sort")}">All songs</a><br>
    <a href="${pageContext.request.contextPath}/profile?id=${user.id}&inst=GUITAR&sort=${pageContext.request.getParameter("sort")}">Guitar songs</a><br>
    <a href="${pageContext.request.contextPath}/profile?id=${user.id}&inst=BASS&sort=${pageContext.request.getParameter("sort")}">Bass songs</a><br>
    <a href="${pageContext.request.contextPath}/profile?id=${user.id}&inst=DRUMS&sort=${pageContext.request.getParameter("sort")}">Drums songs</a><br>
    <a href="${pageContext.request.contextPath}/profile?id=${user.id}&inst=PIANO&sort=${pageContext.request.getParameter("sort")}">Piano songs</a><br>
    <hr>
